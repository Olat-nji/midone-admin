...
(function(window, factory) {
    ...
    Tour = (function() {
        ...
        Tour.prototype._template = function(step, i) {
            ...
            $navigation = $template.find('.navigation');
            ...
            if (step.prev < 0) {
                $prev.addClass('opacity-50 cursor-not-allowed').prop('disabled', true).prop('tabindex', -1);
            }
            if (step.next < 0) {
                $next.addClass('opacity-50 cursor-not-allowed').prop('disabled', true).prop('tabindex', -1);
            }
            if (!step.duration) {
                $resume.remove();
            }
