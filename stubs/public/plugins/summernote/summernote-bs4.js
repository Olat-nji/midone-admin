...
(function(global, factory) {
    ...
    var editor = renderer.create('<div class="note-editor note-frame mx-auto flex items-center"/>');
    var toolbar = renderer.create('<div class="note-toolbar px-1" role="toolbar"></div>');
