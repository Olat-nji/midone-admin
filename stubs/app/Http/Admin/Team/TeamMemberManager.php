...
class TeamMemberManager extends Component
{
     ...
     *
     * @param  \App\Contracts\AddsTeamMembers
     * @return void
     */
    ...
    public function manageRole($userId)
    {
        ...
        $this->managingRoleFor = MainHelper::findUserByIdOrFail($userId);
     ...
     *
     * @param  \App\Actionss\UpdateTeamMemberRole  $updater
     * @return void
     */
     ...
     *
     * @param  \App\Actionss\RemoveTeamMember  $remover
     * @return void
     */
    ...
    public function removeTeamMember(RemoveTeamMember $remover)
    {
        $remover->remove(
            $this->user,
            $this->team,
            $user = MainHelper::findUserByIdOrFail($this->teamMemberIdBeingRemoved)
        );
    ...
    {
        return array_values(MainHelper::$roles);
    }
    ...
    {
        return view('admin.teams.team-member-manager');
    }
}
