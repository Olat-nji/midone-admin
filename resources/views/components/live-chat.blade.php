                        ...
                        <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
                            ...
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 ">
                                <div class="w-12 h-12 flex-none image-fit mr-1">
                                    <img alt="{{$message->last()->fromUser->name}}" class="rounded-full" src="{{$message->last()->fromUser->profile_photo_url}}">
                                    <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                </div>
                                <div class="ml-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">{{$message->last()->fromUser->name}}</a>
                                        <div class="text-xs text-gray-500 ml-auto">{{$message->last()->created_at->diffForHumans()}}/div>
                                        </div>
                                        <div class="w-full truncate text-gray-600">{{Illuminate\Support\Str::words($message->last()->message,10,'...')}}</div>
                                    </div>
                                    @if($message->last()->seen) <div class="w-5 h-5 flex items-center justify-center absolute top-0 right-0 text-xs text-white rounded-full bg-theme-1 font-medium -mt-1 -mr-1">{{$message->where('seen',false)->get()->count()}}</div> @endif
                                </div>
                                @endforeach
                            ...
                            <div class="flex flex-col sm:flex-row border-b border-gray-200 dark:border-dark-5 px-5 py-4">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 sm:w-12 sm:h-12 flex-none image-fit relative">
                                        <img alt="{{$current->name}}" class="rounded-full" src="dist/images/profile-13.jpg">
                                    </div>
