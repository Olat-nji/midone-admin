            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" class="input w-full border @error('job')border-theme-6 @enderror  mt-2" wire:model="job"placeholder="Manager, Git & Fills">
                        @error('job')<div class="text-theme-6 mt-2">{{$message}}</div>@enderror
                    </div>

                    <div class="mt-3">

                        <label>Testimonial</label>
                        <textarea class="input w-full border @error('testimonial')border-theme-6 @enderror mt-2" wire:model="testimonial"></textarea>
                        @error('testimonial')<div class="text-theme-6 mt-2">{{$message}}</div>@enderror
