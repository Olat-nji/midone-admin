...
class ApiTokenManager extends Component
{
    ...
    {
        $this->createApiTokenForm['permissions'] = MainHelper::$defaultPermissions;
    }
    ...
    public function createApiToken()
    {
        ...
        $this->displayTokenValue($this->user->createToken(
            ...
            MainHelper::validPermissions($this->createApiTokenForm['permissions'])
        ));
    ...
    public function updateApiToken()
    {
        $this->managingPermissionsFor->forceFill([
            'abilities' => MainHelper::validPermissions($this->updateApiTokenForm['permissions']),
        ])->save();
    ...
    {
        return view('admin.api.api-token-manager');
    }
}
